...
export default function AddNewPersonalTransactionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: 'Transaction Added', description: 'New personal transaction has been successfully recorded.' });
      router.push(`/transactions/personal`);
    } catch (err: unknown) {
    ...
    <div className="flex flex-col min-h-screen bg-zinc-900 text-white">
      ...
      <div className="flex-1 p-6 space-y-6">
        <div className="flex items-center gap-4">
          <Link href="/transactions/personal"><Button variant="ghost" size="icon" className="bg-zinc-800 text-white border-zinc-700 hover:bg-zinc-700"><ArrowLeft className="h-4 w-4" /></Button></Link>
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">New Personal Transaction</h1>
            <p className="text-sm text-zinc-400">Record a new personal transaction.</p>
          </div>
        </div>
