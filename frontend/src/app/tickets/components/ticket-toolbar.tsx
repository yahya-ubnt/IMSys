  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
      <div className="flex items-center gap-2">
        ...
        <Button size="sm" className={table.getColumn('status')?.getFilterValue() === 'Open' ? 'bg-blue-500 text-white hover:bg-blue-600' : 'bg-transparent border border-zinc-700 text-zinc-400 hover:bg-zinc-800'} onClick={() => table.getColumn('status')?.setFilterValue('Open')}>Open</Button>
        ...
        <Button size="sm" className={table.getColumn('status')?.getFilterValue() === 'Fixed' ? 'bg-blue-500 text-white hover:bg-blue-600' : 'bg-transparent border border-zinc-700 text-zinc-400 hover:bg-zinc-800'} onClick={() => table.getColumn('status')?.setFilterValue('Fixed')}>Fixed</Button>
