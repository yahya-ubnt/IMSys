...
function LoginPageContent() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // Check credentials (demo users)
    const demoUsers = [
      { email: "admin@mediatek.com", password: "Abuhureira12", name: "John Doe", role: "Sales Manager" },
      { email: "manager@mediatek.com", password: "Manager123!", name: "Sarah Wilson", role: "Property Manager" },
      { email: "agent@mediatek.com", password: "Agent123!", name: "Mike Johnson", role: "Sales Agent" },
    ]
