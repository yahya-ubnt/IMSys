...
router.route('/').post(isSuperAdminOrAdmin, createBill).get(isSuperAdminOrAdmin, getBills);
router
  .route('/:id')
  .get(isSuperAdminOrAdmin, getBillById)
  .put(
    isSuperAdminOrAdmin,
    [
  ...
  .delete(isSuperAdminOrAdmin, deleteBill);
